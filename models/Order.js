...
Order.belongsTo(DeliveryAddress, { foreignKey: 'deliveryAddressID', onDelete: 'CASCADE' });
DeliveryAddress.hasMany(Order, { foreignKey: 'deliveryAddressID' });

Order.belongsTo(ShopperClaimedVoucher, { foreignKey: 'shopperClaimedVoucherID', onDelete: 'CASCADE' });
